...
#define ILI9488_SWRESET       0x01 // soft reset
...
#define ILI9488_RDPIXFMT      0x0C // Read Pixel Format
...
#define ILI9488_DISPON        0x29 // Display ON (causes display to show what's in memory; no effect if display mode already on)
...
#define ILI9488_MADCTL        0x36 // Memory Access Control: configures rgb/bgr color format and determines which pixel direction to move
#define ILI9488_VSCRSADD      0x37
#define ILI9488_PIXFMT        0x3A // Interface Pixel Format
#define ILI9488_RAMWRCONT     0x3C // Memory Write Continue
#define ILI9488_RAMRDCONT     0x3E // Memory Read Continue

#define ILI9488_IMCTR         0xB0 // Interface Mode Control
#define ILI9488_FRMCTR1       0xB1 // Frame Rate Control 1-3
...
#define ILI9488_GMCTRP1       0xE0 // PGAMCTRL(Positive Gamma Control)
#define ILI9488_GMCTRN1       0xE1 // NGAMCTRL(Negative Gamma Control)
#define ILI9488_IMGFUNCT      0xE9 // Set Image Function

#define ILI9488_ADJCTR3       0xF7 // Adjust Control 3
